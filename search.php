        ...
        <style>
            ...
            @media (max-width: 767.98px) {
              ...
              <?php
                        ...
                        $Searchsql = "SELECT * FROM `data` WHERE live=1 and (`tags` LIKE '%".$search_query."%' or `title` LIKE '%".$search_query."%')";                                                
                        $SearchResult = mysqli_query($conn, $Searchsql);                        
                        $NoOfRow = mysqli_num_rows($SearchResult);
                        
                ?>
        
        <div class="main" style="margin-top: 10px;"><br>
            <h4 class="display-5 jumbotron shadow-sm p-3 mb-5 bg-light border" style="padding:10px; text-align: center;"><?php echo $NoOfRow?> of Result Found For <i>'<?php echo strtoupper($search_query);?>'</i></h4>            
